...
type SrvStat struct {
	...
	SysTotalRamMB  int   `json:"sysTotalRamMB"`
	SysFreeRamMB   int   `json:"sysFreeRamMB"`
	SysTotalSwapMB int   `json:"sysTotalSwapMB"`
	SysFreeSwapMB  int   `json:"sysFreeSwapMB"`
}
...
func (stat *SrvStatInternal) Equal(stat2 *SrvStatInternal) bool {
	...
	return isAboveThreshold(stat.SysFreeRamMB, stat2.SysFreeRamMB, stat.ThresholdPercent, "freeRam") &&
